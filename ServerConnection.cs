...
namespace MediSync {
    public class ServerConnection {
		...
		public virtual Configuration GetServerConfiguration() {
			return GetServerConfiguration(false);
		}

		public virtual Configuration GetServerConfiguration(bool forceConfig) {
            Boolean ssl;
            Boolean addConfig;
            int configNumber;
            ...
            if (isConfigExist) {
                ...
                ConsoleHelper.Color(ConsoleForeground.DarkGray);
                System.Console.WriteLine("Hint: prepend your selection with an asterisk * to make that selection the default.  \nExample: \n*2");
                System.Console.WriteLine();
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //                                  ALLOW A DEFAULT AUTO SELECTION                                          //
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////
                String input;
				String defaultCrmConfigChoice = Settings.DefaultCrmServerChoice;

				if (forceConfig) {
					defaultCrmConfigChoice = "0";
				}

                try {
                    if (defaultCrmConfigChoice != null) {
                        input = defaultCrmConfigChoice;
                    } else {
                        input = System.Console.ReadLine();
                        if (input.StartsWith("*")) {
                            input = input.Replace("*", "");
                            Settings.DefaultCrmServerChoice = input;
                        }
                    }
                } catch (Exception e) {
                    input = System.Console.ReadLine();
            ...
            if (addConfig) {
				...
				config.ServerAddress = "crmauth.medistim.com";
		...
		public static ClientCredentials GetUserLogonCredentials(ServerConnection.Configuration config) {
			return GetUserLogonCredentials(config, false);
		}
			/// <summary>
			...
			public static ClientCredentials GetUserLogonCredentials(ServerConnection.Configuration config, bool resetPassword) {
            ...
            switch (config.EndpointType) {
                ...
                case AuthenticationProviderType.ActiveDirectory:
                    ...
                    // Prompts users to enter credential for current organization.
                        ...
                        do {
                            System.Console.Write("\nEnter domain\\username: ");
                            domainAndUserName = System.Console.ReadLine().Split('\\');
                ...
                case AuthenticationProviderType.OnlineFederation:
                    ...
                    if (isCredentialExist) {
                        ...
                        if (String.IsNullOrWhiteSpace(config.Credentials.UserName.Password)) {
                            System.Console.Write("\n Enter Username: ");
                            System.Console.WriteLine(config.Credentials.UserName.UserName);
            ...
            while (info.Key != ConsoleKey.Enter) {
                if (info.Key == ConsoleKey.Backspace) {
                    if (ssPassword.Length != 0) {
                        ...
                        System.Console.Write("\b \b");     // erase last char
                    }
        ...
        protected virtual String GetServerAddress(out bool ssl) {
            ...
            System.Console.Write("Enter a CRM server name and port [crm.dynamics.com]: ");
            String server = System.Console.ReadLine();

            if (server.EndsWith(".dynamics.com") || String.IsNullOrWhiteSpace(server)) {
                ssl = true;
            } else {
                System.Console.Write("Is this server configured for Secure Socket Layer (https) (y/n) [n]: ");
        ...
        protected virtual Boolean GetOrgType(String server) {
            ...
            System.Console.Write("Is this organization provisioned in Microsoft Office 365 (y/n) [y]: ");
            String answer = System.Console.ReadLine();
        ...
        private static class CrmServiceHelperConstants {
            ...
            /// </summary>
            public static readonly string ServerCredentialsFile = 
                Path.Combine(
                    Path.Combine(
